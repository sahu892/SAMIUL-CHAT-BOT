...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস সামিউল রে একটা গার্লফ্রেন্ড দে..!🐸🥵",
    ...
    "ami samiul": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌𝑆𝑎𝑚𝑖𝑢𝑙 𝑖𝑠𝑙𝑎𝑚 𝐶ℎ𝑎𝑡 𝑏𝑜𝑡💖",
    ...
    "kire bot": "হ্যাঁ সব কেমন আছেন আপনার ঠোটে উম্মাহ 😘😽🙈",
